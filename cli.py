            ...
            for weeks_ago in range(8, 0, -1):  # 8 weeks ago to 1 week ago
                ...
                if weeks_ago <= 2:  # Recent weeks might be festive
                    if random.random() < 0.3:  # 30% chance
                        ...
                        tipo_festivita = random.choice([FestivityType.NATALE, FestivityType.PASQUA])
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Italian Hymns API - Command Line Interface",
        prog="python cli.py"
    )
    ...
    # Scrape command
    scrape_parser = subparsers.add_parser("scrape", help="Scrape hymns data from the web")
    ...
    # Stats command
    stats_parser = subparsers.add_parser("stats", help="Show hymn collection statistics")
